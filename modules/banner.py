"""
    ...
    Copyright (C) 2024  ScarletPhantom (github.com/HelloNathan9999)
    ...
    original developer, [ScarletPhantom (github.com/HelloNathan9999)], and copying the code
    is not permitted without permission.

    For any queries, Contact me at :ScarletPhantom@protonmail.com
"""
...
banner2 = f"""
        ...
        ░█─── ▀──▀ ▀▀▀▀ ▀──▀ ▀▀▀ ░█▄▄▄█ █▀▀▀ ▀▀▀ ▀▀▀▀ ▀▀▀ ──▀── 　 ░█─── ▀─▀▀ ▀▀▀▀
            ...
            {color.RED}{version}{color.WHITE}            {color.WHITE}By github.com/ScarletPhantom
"""
...
"""
"""
Copyright © 2024 ScarletPhantom (github.com/HelloNathan9999)
Copyright © 2024 SaffiarSigit (github.com/HelloNathan9999)
"""
